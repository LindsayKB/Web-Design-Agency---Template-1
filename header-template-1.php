...
<head>
	...
	<link rel="pingback" href="<?php bloginfo( 'pingback_url' ); ?>" />
			<link rel="stylesheet" type="text/css" href="../wp-content/themes/vantage/css/custom-template-1.css">
	<?php wp_head(); ?>
</head>
...
<div id="page-wrapper">
	...
	<?php if( ! siteorigin_page_setting( 'hide_masthead', false ) ) : ?>
		...
		<?php get_template_part( 'parts/masthead-template-1', apply_filters( 'vantage_masthead_type', siteorigin_setting( 'layout_masthead' ) ) ); ?>
